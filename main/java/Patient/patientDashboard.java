...
public class patientDashboard extends AppCompatActivity
    ...
    private void replacefragment(Fragment fragement){
        ...
        ft.replace(R.id.homedefaultfragment, fragement);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startService(new Intent(this, service_appointmentReminder.class));
        startService(new Intent(this, service_appointmentResponse.class));
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        replacefragment(new fragment_home());
        this.setTitle("DoctorCategory");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            replacefragment(new fragment_patient_appointments_status());
            this.setTitle("Appintment Status");
        }
