package com.example.shahidhussain.assignemnt2.PA;
...
import com.example.shahidhussain.assignemnt2.Doctor.fragment_doctor_appointment;
...
public class padashboard extends AppCompatActivity
    ...
    private void replacefragment(Fragment fragement){
        ...
        ft.replace(R.id.pahomefragment, fragement);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_padashboard);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.padashboard, menu);
        return true;
    }
